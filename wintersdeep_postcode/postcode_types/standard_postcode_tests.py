...
class TestStandardPostcode(TestCase):
    ...
    def test__StadardPostcode_ctor(self):
        ...
        regex_match = test_regex.match("A0 1BC")
        test_postcode = StandardPostcode(regex_match)
        self.assertEqual(test_postcode.outward_area, "A")
        self.assertEqual(test_postcode.outward_district, "0")
        self.assertEqual(test_postcode.inward_sector, "1")
        self.assertEqual(test_postcode.inward_unit, "BC")

        regex_match = test_regex.match("A01 2BC")
        test_postcode = StandardPostcode(regex_match)
        self.assertEqual(test_postcode.outward_area, "A")
        self.assertEqual(test_postcode.outward_district, "01")
        self.assertEqual(test_postcode.inward_sector, "2")
        self.assertEqual(test_postcode.inward_unit, "BC")
        
        regex_match = test_regex.match("A0B 1CD")
        test_postcode = StandardPostcode(regex_match)
        self.assertEqual(test_postcode.outward_area, "A")
        self.assertEqual(test_postcode.outward_district, "0B")
        self.assertEqual(test_postcode.inward_sector, "1")
        self.assertEqual(test_postcode.inward_unit, "CD")
        
        regex_match = test_regex.match("AB0 1CD")
        test_postcode = StandardPostcode(regex_match)
        ...
        regex_match = test_regex.match("AB01 2CD")
        test_postcode = StandardPostcode(regex_match)
        self.assertEqual(test_postcode.outward_area, "AB")
        self.assertEqual(test_postcode.outward_district, "01")
        self.assertEqual(test_postcode.inward_sector, "2")
        ...
        regex_match = test_regex.match("AB0C 1DE")
        test_postcode = StandardPostcode(regex_match)
        self.assertEqual(test_postcode.outward_area, "AB")
        self.assertEqual(test_postcode.outward_district, "0C")
        self.assertEqual(test_postcode.inward_sector, "1")
